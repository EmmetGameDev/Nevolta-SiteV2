...
import { N32_Thumbnail, ThumbnailESP32, ThumbnailNexus } from '../../assets/photos/index.js';
    ...
    return(
        <div className="container-fluid m-0 p-0 d-flex flex-column min-vh-100">
            ...
            <div className="container text-center flex-grow-1">
                ...
                <div className='row'>
                    <BlogColumn title="Nevolta32 Release" photoSrc={N32_Thumbnail} iconSrc={Youtube} shortDescs={["The first commercial Nevolta Console release!"]} date="23.07.2026" ButtonLinks={[{ link: "https://shop.nevoltasystems.com/products/nevolta32-console", text: "Preorder" },{ link: "https://www.youtube.com/watch?v=sddctJ3Ue2Y", text: "YouTube" }]} />
